CLASS zcl_fill_accounts_002 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_fill_accounts_002 IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.

    DATA: lt_accounts type table of ZCUENTAS.
    ...
    DELETE FROM ZCUENTAS.

    INSERT ZCUENTAS from table @lt_accounts.
