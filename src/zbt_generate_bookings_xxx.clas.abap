CLASS zbt_generate_bookings_xxx DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zbt_generate_bookings_xxx IMPLEMENTATION.
...
*   Delete the possible entries in the database table - in case it was already filled
    DELETE FROM ZTBOOKING_002.
*   insert the new table entries
    INSERT ZTBOOKING_002 FROM TABLE @it_bookings.

*   check the result
    SELECT * FROM ZTBOOKING_002 INTO TABLE @it_bookings.
    out->write( sy-dbcnt ).
